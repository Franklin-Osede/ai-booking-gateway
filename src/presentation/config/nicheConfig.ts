  ...
  aesthetic: {
    ...
    voice_scripts: {
      ...
      deep_dive_chips: {
         ...
         "Láser Médico": ["Manchas y Rojeces", "Marcas de Acné", "Ver Especialistas"]
      },
      deep_dive_scripts: {
         ...
         "Volumen en Labios": "Genial. Emplearemos ácido hialurónico ultra-elástico logrando una hidratación profunda y un perfilado de proporción áurea, sin perder un milímetro de naturalidad.",
         ...
         "Marcas de Acné": "Estupendo. Radiofrecuencia fraccionada como Morpheus 8 romperá el tejido cicatrizal, generando una piel completamente lisa y sin poros."
      },
