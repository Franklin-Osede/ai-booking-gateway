    ...
    <div className={`fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 pointer-events-none`}>
      ...
      <AnimatePresence mode="wait">
        <motion.div 
           ...
           className={`relative w-full max-w-[400px] sm:max-w-[460px] min-h-[380px] sm:min-h-[520px] max-h-[85vh] h-auto bg-[#f8fafc] rounded-[2.5rem] shadow-[0_25px_65px_-15px_rgba(0,0,0,0.15)] ring-1 ring-gray-900/5 flex flex-col overflow-hidden pointer-events-auto font-sans antialiased text-gray-900`}
        >
