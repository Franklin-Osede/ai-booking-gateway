...
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const { name, industry, location, notes, primaryColor, videoUrl, seoMetrics, widgetPosition } = body;

    const updateData: Record<string, unknown> = { name, industry, location, notes, videoUrl, seoMetrics, widgetPosition };
